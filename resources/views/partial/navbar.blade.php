<nav class="py-2 bg-body-tertiary border-bottom">
    <div class="container d-flex flex-wrap">
        <ul class="nav me-auto">
            ...
            <li class="nav-item"><a href="{{ route('record.music') }}" class="nav-link link-body-emphasis px-2">Музыка</a></li>
            <li class="nav-item"><a href="{{ route('record.video') }}" class="nav-link link-body-emphasis px-2">{{ __('menu.video') }}</a></li>
