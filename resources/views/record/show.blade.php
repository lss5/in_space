    ...
    <div class="container">
        <div class="row bg-white py-5">
            <div class="col-12 col-lg-8 mx-auto d-flex flex-column">
                ...
                @auth
                    @if($like)
                    <a href="{{ route('like.delete', $like) }}" class="text-danger mx-1">
                    ...
                    @else
                    <a href="{{ route('like.create', $record) }}" class="text-secondary mx-1">
                    ...
                    @endif
                @endauth
                    <a href="{{ route('record.edit', $record) }}" class="btn btn-secondary mx-1">{{ __('button.edit') }}</a>
                    ...
                    <a href="{{ route('record.index') }}" class="btn btn-secondary mx-1">Все записи</a>
                </div>
            </div>
        </div>
    </div>
