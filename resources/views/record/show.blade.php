            ...
            <div class="col-12 col-lg-8 mx-auto d-flex flex-column">
                ...
                @auth
                    ...
                    <div class="d-flex flex-row align-items-center">
                        ...
                        @else
                            <a href="{{ route('user.like.create', $record) }}" class="text-secondary mx-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
                        ...
                        @endif
                        @if($dislike)
                            <a href="{{ route('user.dislike.delete', $dislike) }}" class="text-danger mx-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-hand-thumbs-down-fill" viewBox="0 0 16 16">
                        ...
                        @else
                            <a href="{{ route('user.dislike.create', $record) }}" class="text-secondary mx-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-hand-thumbs-down" viewBox="0 0 16 16">
